namespace VacationDaysCalculatorWebAPI.Constants
{
	public class StringConstants
	{
		...
		public const string NEW_VACATION_REQUEST_MESSAGE_P_TAG = "<p>You have new vacation request.</p> <p>Please go to NAIS System to approve or decline request.</p> <p>Kind regards,</p> <p>NAIS team</p>";
